...
plt.legend(["PSD", "Line of Best Fit: -66.88 log(f) - 254.82"])
...
plt.legend(["PSD", "Line of Best Fit: -69.56 log(f) - 268.09"])
...
plt.legend(["PSD", "Line of Best Fit: -67.30 log(f) - 256.48"])
